...
#pragma warning disable CS8602
    ...
    public unsafe void TestUpdate(UnkTargetFollowStruct* unk1)
    {
        ...
        //_logger.Debug($"PRE:       UnkTargetFollowStruct: {((IntPtr)unk1).ToString("X")}");
        //_logger.Debug($"---------------------------------");
        //_logger.Debug($"PRE: Unk_0x450.Unk_GameObjectID0: {unk1->Unk_0x450.Unk_GameObjectID0.ToString("X")};");
        try
        {
            //_logger.Debug($"PRE      Struct target4 Unk_0x10: {unk1->Unk_0x450.Unk_0x10};");
            //_logger.Debug($"PRE      Struct target4 Unk_0x54: {unk1->Unk_0x450.Unk_0x54};");
        }
        catch (Exception ex)
        {
            _logger.Error($"Error converting Unk_0x10 to string: {ex}");
        }
        //_logger.Debug($"PRE:             FollowingTarget: {unk1->FollowingTarget.ToString("X")}");
        //_logger.Debug($"PRE:                 Follow Type: {unk1->FollowType.ToString("X")}");
        ...
        foreach (Dalamud.Game.ClientState.Objects.Types.IGameObject obj in _objectTable)
        {
            ...
            {
                //_logger.Debug($"Game Object To Follow: {unk1->GameObjectIDToFollow.ToString("X")}: {obj.Name.TextValue}");
                break;
            }
        }
        ...
        {
            //_logger.Debug($"Unfollow Hook was valid, performing Early escaping to prevent canceling follow!");
            return; // do an early return to prevent processing
        }
        else
        {
            //_logger.Debug($"Unk_0x450.Unk_0x54 was {unk1->Unk_0x450.Unk_0x54}. Performing early return of original.");
            // output the original
        ...
        try
        {
            //_logger.Debug($"POST       UnkTargetFollowStruct: {((IntPtr)unk1).ToString("X")}");
            //_logger.Debug($"---------------------------------");
            //_logger.Debug($"POST Unk_0x450.Unk_GameObjectID0: {unk1->Unk_0x450.Unk_GameObjectID0.ToString("X")};");
            //_logger.Debug($"POST     Struct target4 Unk_0x54: {unk1->Unk_0x450.Unk_0x54};");
            //_logger.Debug($"POST             FollowingTarget: {unk1->FollowingTarget.ToString("X")}");
            //_logger.Debug($"POST                 Follow Type: {unk1->FollowType.ToString("X")}");
        }
        catch (Exception ex)
        {
        ...
        foreach (Dalamud.Game.ClientState.Objects.Types.IGameObject obj in _objectTable)
        {
            if (obj.GameObjectId == unk1->GameObjectIDToFollow)
            {
                _logger.Debug($"POST ObjectIDtoFollow: {unk1->GameObjectIDToFollow.ToString("X")}: {obj.Name.TextValue}");
                break;
            }
        }
    }

    public unsafe MoveController(IPluginLog logger,
...
#pragma warning restore CS8602
    public void EnableMovementLock()
    {
        ...
        _logger.Verbose("Disabling All Movement due to Move Lock State condition starting");
    ...
    public void DisableMovementLock()
    {
        ...
        _logger.Verbose("Enabling All Movement due to Move Lock State condition ending");
    ...
    public void EnableUnfollowHook()
    {
        ...
        {
            UnfollowHook.Enable();
            _logger.Verbose($"UnfollowHook is enabled due to Move Lock State");
        }
    }
    ...
    public void DisableUnfollowHook()
    {
        ...
        if (UnfollowHook is not null && UnfollowHook.IsEnabled)
        {
            ...
            _logger.Verbose($"UnfollowHook is disabled due to Move Lock State ending");
        }
    }
    ...
    public void Dispose()
    {
        _logger.Debug($"Disposing of MoveController");
